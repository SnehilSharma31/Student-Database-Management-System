...
struct University
{
    ...
    char UniversityName[50], UniversityLocation[50];
...
void display_branches(struct Branch *p)
{
    if (p == NULL)
    {
        printf("\nERROR!!\nERROR DESCRIPTION : Branch details is not available in the database\nSOLUTION          : Please enter the details of Branch in the database\n\n");
    ...
    do
    {
        ...
        if (check_uid_repeat(s) == 1)
        {
            printf("\nERROR !!\n\nERROR DESCRIPTION : University with this ID does not exists\nSOLUTION          : Please enter valid University ID\n\n");
            system("pause");
            return;
        }
    } while (check_uid_repeat(s) == 1);
...
void displayDetailsForsubString(struct Student *head)
{
    struct Student *curr = head;
    char *substring, *p;
    int i = 1;
    
    printf("Please enter the Substring you want to Search : ");
    scanf("%s", &substring);

    while (curr != NULL)
    {
        p = strstr(curr->Name, substring);
...
void swap(struct University *a, struct University *b)
{
    int temp = a->Yearofstart;

    a->Yearofstart = b->Yearofstart;
    b->Yearofstart = temp;
}

struct University *univsort(struct University *start)
{
    int swapped, i;
    struct University *ptr1;
    struct University *lptr = NULL;
    ...
    do
    {
        ...
        while (ptr1->next2 != lptr)
        {
            if (ptr1->Yearofstart > ptr1->next2->Yearofstart)
            { 
                swap(ptr1, ptr1->next2);
                swapped = 1;
            }
...
void printList(struct University *start)
{
    struct University *temp = start;
...
void DetailsinAcending(struct University *head){
           
    struct University *result = univsort(head);
...
void welcome()
{
    ...
    printf("\n\t\t\t\t\t\tACKNOWLEDGEMENT\n");
    printf("\t\t\t\t\t\t---------------\n");
    printf("\nWe are grateful to our respectable professor, Dr. Arup Abhinna Acharya, whose insightful leadership and knowledge benefited us to complete this project successfully.\nWe are thankful to him for his continuous support and presence whenever needed.\n\n");
    ...
    printf("\t\t\t\t\t |  ROLL NO.            NAME         |\n");
    printf("\t\t\t\t\t |-----------------------------------|\n");
    printf("\t\t\t\t\t |  2005492       Abhyuday Mishra    |\n");
    printf("\t\t\t\t\t |-----------------------------------|\n");
    printf("\t\t\t\t\t |  2005493       Abhyudaya Baghel   |\n");
    printf("\t\t\t\t\t |-----------------------------------|\n");
    printf("\t\t\t\t\t |  2005501         Ankit Kumar      |\n");
    printf("\t\t\t\t\t |-----------------------------------|\n");
    printf("\t\t\t\t\t |  2005535         Sahil Singh      |\n");
    printf("\t\t\t\t\t |-----------------------------------|\n");
    printf("\t\t\t\t\t |  2005545        Snehil Sharma     |\n");
    printf("\t\t\t\t\t |-----------------------------------|\n");
    printf("\t\t\t\t\t |  2005546        Sonam Kumari      |\n");
    printf("\t\t\t\t\t |___________________________________|\n\n");
    printf("\t\t\t\t\t   ");
    system("pause");
}
...
int main()
{
    ...
    while (1)
    {
        ...
        printf("\nPress 9  - To MODIFY / UPDATE using key values in any of the databases as per the requirement");
        ...
        switch (choice)
        {
            ...
            case 11:
                system("cls");
                display_branches(third);
                break;

            case 12:
                system("cls");
                DetailsinAcending(second);
                break;

            case 13:
                system("cls");
                displayDetailsForsubString(first);
                break;
            ...
            case 14:
                ...
                printf("\n\nExiting in ");
                for(int i=2;i>-2;i--){
                    int ms=1000*1;clock_t t=clock();while(clock()<t+ms);
                    printf("%d ",i+1);
                }
